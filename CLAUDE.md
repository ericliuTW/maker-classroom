...
- 2026-04-16：教室配置「庫存物品」側欄開放給所有使用者（拖曳+選擇功能不再限教師）；家具對話框「新增/編輯器材」與數量調整移除教師限制
- 2026-04-16：專案規劃設備清單全面改版 — 合併選擇器+週曆排程成單一元件（EquipmentSection）：點條目彈出庫存選擇器、可自訂設備名稱+場地、選完後內嵌週曆顯示可借用時段（綠/藍/紅）、直接點擊格子排程、上下週切換
- 2026-04-16：教室配置圖家具對話框新增「新增／編輯器材」功能：可複選器材、各自調整數量、搜尋篩選、已放入的器材預設勾選
